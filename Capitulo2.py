    ...
    # Algoritmo Ordenação por Seleção: organizando uma lista do menor para o maior valor
...
# Escrevendo o algoritmo de Ordenação por Seleção propriamente dito (dentro dele utiliza-se da função criada anteriormente)
def ordenacao_selecao(lista):
    ...
    # Testando o algoritmo Ordenção por Seleção (ordenação crescente)
minha_lista = [5, 3, 6, 2, 10]

print(ordenacao_selecao(minha_lista))

    # Determinando tempo de execução para o algoritmo Ordenação por Seleção com n = 100 (notação 'Big O')
...
print(tempo_execucao)
    ...
    # Escreveno algoritmo de Ordenação por Seleção do maior para o menor valor (isto não está no capítulo,
...
# Escrevendo o algoritmo de Ordenação por Seleção propriamente dito (dentro dele também utiliza-se da função criada anteriormente)
...
# Testando o algoritmo Ordenção por Seleção (ordenação decrescente)
minha_lista = [5, 3, 6, 2, 10]
